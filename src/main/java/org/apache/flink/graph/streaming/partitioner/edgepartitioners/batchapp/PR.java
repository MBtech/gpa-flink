...
public class PR implements App{
...
//        data.partitionCustom(partitioner, new CustomKeySelector<>(0)).setParallelism(1).writeAsCsv(partitionPath, FileSystem.WriteMode.OVERWRITE).setParallelism(3);
