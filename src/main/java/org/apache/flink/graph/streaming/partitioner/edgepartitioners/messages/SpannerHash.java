...
public class SpannerHash {
	...
	public static void main(String[] args) throws Exception {
		...
		GraphStream<Long, NullValue, NullValue> graph = new SimpleEdgeStream<>(edges.partitionCustom(new HashPartitioner<>(new CustomKeySelector(0)), new CustomKeySelector<>(0)),env);
		...
		/*spanner.flatMap(new FlattenSet())
				.keyBy(0).timeWindow(Time.of(50, TimeUnit.MILLISECONDS))
